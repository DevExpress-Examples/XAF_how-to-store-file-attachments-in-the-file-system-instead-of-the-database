...
public class E965WindowsFormsApplication : WinApplication {
    ...
    protected override void OnSetupComplete() {
        ...
        var fileAttachmentsWindowsFormsModule = this.Modules.FindModule<FileAttachmentsWindowsFormsModule>();
        fileAttachmentsWindowsFormsModule.CustomOpenFileWithDefaultProgram += FileAttachmentsWindowsFormsModule_CustomOpenFileWithDefaultProgram;
    }

    private void FileAttachmentsWindowsFormsModule_CustomOpenFileWithDefaultProgram(object sender, CustomFileOperationEventArgs e) {
