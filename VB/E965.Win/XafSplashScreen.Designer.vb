Namespace E965.Win
	Partial Public Class XafSplashScreen
		...
		Private Sub InitializeComponent()
			Dim resources As New System.ComponentModel.ComponentResourceManager(GetType(XafSplashScreen))
			...
			DirectCast(Me.progressBarControl.Properties, System.ComponentModel.ISupportInitialize).BeginInit()
			DirectCast(Me.peImage.Properties, System.ComponentModel.ISupportInitialize).BeginInit()
			DirectCast(Me.peLogo.Properties, System.ComponentModel.ISupportInitialize).BeginInit()
			DirectCast(Me.pcApplicationName, System.ComponentModel.ISupportInitialize).BeginInit()
			...
			' peImage
			' 
			Me.peImage.EditValue = (DirectCast(resources.GetObject("peImage.EditValue"), Object))
			...
			' peLogo
			' 
			Me.peLogo.EditValue = (DirectCast(resources.GetObject("peLogo.EditValue"), Object))
			...
			Me.Text = "Form1"
			DirectCast(Me.progressBarControl.Properties, System.ComponentModel.ISupportInitialize).EndInit()
			DirectCast(Me.peImage.Properties, System.ComponentModel.ISupportInitialize).EndInit()
			DirectCast(Me.peLogo.Properties, System.ComponentModel.ISupportInitialize).EndInit()
			DirectCast(Me.pcApplicationName, System.ComponentModel.ISupportInitialize).EndInit()
